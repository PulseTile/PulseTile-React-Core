export const valuesNames = {
  ...
  REALATIONSHIP_TYPE: 'relationshipType',
  REALATIONSHIP_CODE: 'relationshipCode',
  REALATIONSHIP_TERMINOLOGY: 'relationshipTerminology',
...
export const valuesLabels = {
  ...
  REALATIONSHIP_TYPE: 'Relationship Type',
  REALATIONSHIP_CODE: 'Relationship Terminology',
  REALATIONSHIP_TERMINOLOGY: 'Relationship Code',
