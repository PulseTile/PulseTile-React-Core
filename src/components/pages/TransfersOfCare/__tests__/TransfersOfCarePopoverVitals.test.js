...
import TransfersOfCarePopoverVitals from '../transfers-of-care-components/TransfersOfCarePopoverVitals';
import { valuesLabels, valuesNames, valuesAddons } from '../../Vitals/forms.config';
