...
export default class VaccinationDetail extends PureComponent {
  render() {
    const { onExpand, openedPanel, expandedPanel, currentPanel, detail, onEdit, editedPanel, onCancel, onSaveSettings, vaccinationPanelFormValues, isSubmit } = this.props;
