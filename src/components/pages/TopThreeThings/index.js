...
const epics = combineEpics(fetchPatientTopThreeThingsEpic, fetchPatientTopThreeThingsSynopsisEpic, fetchPatientTopThreeThingsDetailEpic, fetchPatientTopThreeThingsDetailEditEpic, fetchPatientTopThreeThingsUpdateEpic);
