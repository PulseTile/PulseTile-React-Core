...
describe('Component <Events />', () => {
  it('should renders correctly with eventsDetail and testing Detail Panel', () => {
    ...
    // Testing onClose methods
    component.instance().onClose({ appointmentId: 'a7007401-837f-471c-8f73-cbb53c0eb1a1' });
    component.instance().onClose({ appointmentId: 'a7007401-837f-471c-8f73-cbb53c0eb1a2' });

    // Testing onAppointmentInit methods
    component.instance().onAppointmentInit({ appointmentId: 'a7007401-837f-471c-8f73-cbb53c0eb1a1' });
  ...
  it('should renders correctly and testing context and lifecycle componentWillReceiveProps', () => {
    ...
    component.setProps({ test: 'testing edit context', eventDetail: { sourceId: 'newSourceId' } });
    component.setProps({ test: 'testing edit context', eventDetail: {} });
    component.setProps({ test: 'testing edit context', eventDetail: { sourceId: 'acb0eaf2-d1df-4c7a-9382-619b31935f2b' } });
