...
import EventsDetailPanel from '../EventsDetail/EventsDetailPanel';
  ...
  it('should renders with all props correctly', () => {
    const component = shallow(
      <EventsDetailPanel
        ...
        startAppointment={testProps.startAppointment}
        joinAppointment={testProps.joinAppointment}
    ...
    expect(component.find('.btn-text').at(1).text()).toEqual('Join Appointment');
    expect(component.find('.btn-text').at(2).text()).toEqual(' Edit');
    ...
    component.setProps({
      ...
      canJoinAppointment: () => false,
    });

    expect(component.find('.btn-text').at(0).text()).toEqual(' Edit');
