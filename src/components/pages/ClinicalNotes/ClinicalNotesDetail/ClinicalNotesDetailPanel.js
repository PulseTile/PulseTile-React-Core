...
import ClinicalNotesDetailHeader from '../header/ClinicalNotesDetailHeader';

export default class ClinicalNotesDetailPanel extends PureComponent {
  static propTypes = {
  ...
  render() {
    ...
    return (
      <div className={classNames('panel panel-secondary', { open: isOpen })}>
        <ClinicalNotesDetailHeader onExpand={onExpand} name={name} title={title} currentPanel={currentPanel} />
