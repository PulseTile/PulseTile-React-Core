...
export class App extends Component {
  render() {
    ...
    const isTouchDevice = this.props.isTouchDevice
      ? "touch-device"
      ...
      <div>
        ...
        {!isIE && (
          <div className="page">
            ...
            {!_.isEmpty(patientsInfo) ? (
              <div style={{ height: "100%" }}>
                <div className={classNames("wrapper", isTouchDevice)}>
                  <header className="header">
                    <TopHeader isHasSearch={themeConfigs.headerHasSearch}>
                      {themeConfigs.isLeedsPHRHeaderList ? (
                        <HeaderList
                          items={[<img src={image} alt="header img 2" />]}
                        />
                      ) : (
                        <div />
                      )}
