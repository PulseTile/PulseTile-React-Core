...
import TransfersOfCarePopoverMedications from '../../../src/components/pages/TransfersOfCare/transfers-of-care-components/TransfersOfCarePopoverMedications';
import { valuesLabels, valuesNames } from '../../../src/components/pages/Medications/forms.config';
...
describe('Component <TransfersOfCarePopoverMedications />', () => {
  it('should renders with props correctly', () => {
    const component = shallow(
      <TransfersOfCarePopoverMedications
