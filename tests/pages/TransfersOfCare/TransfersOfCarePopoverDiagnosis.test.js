...
import TransfersOfCarePopoverDiagnosis from '../../../src/components/pages/TransfersOfCare/transfers-of-care-components/TransfersOfCarePopoverDiagnosis';
import { valuesLabels, valuesNames } from '../../../src/components/pages/ProblemsDiagnosis/forms.config';
...
describe('Component <TransfersOfCarePopoverDiagnosis />', () => {
  it('should renders with props correctly', () => {
    const component = shallow(
      <TransfersOfCarePopoverDiagnosis
