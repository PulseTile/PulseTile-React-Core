...
import MedicationsDetailPanel from '../../../src/components/pages/Medications/MedicationsDetail/MedicationsDetailPanel';
...
describe('Component <MedicationsDetailPanel />', () => {
  it('should renders with all props correctly', () => {
    const component = shallow(
      <MedicationsDetailPanel
